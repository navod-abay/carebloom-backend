...
// */
// @GetMapping
// public ResponseEntity<List<Midwife>> getAllMidwives(Authentication
// authentication) {
...
// Authentication authentication) {
// String firebaseUid = authentication.getName();
// Midwife updatedMidwife = midwifeService.updateMidwife(midwifeId, request,
// firebaseUid);
...
// Authentication authentication) {
// String firebaseUid = authentication.getName();
// List<Midwife> midwives = midwifeService.getMidwivesByClinic(clinic,
// firebaseUid);
// return ResponseEntity.ok(midwives);
// }
...
// midwifeService.getMidwivesBySpecialization(specialization, firebaseUid);
// return ResponseEntity.ok(midwives);
// }
...
// */
// @GetMapping("/clinics")
// public ResponseEntity<List<String>> getAvailableClinics(Authentication
// authentication) {
// String firebaseUid = authentication.getName();
// List<Midwife> midwives = midwifeService.getAllMidwives(firebaseUid);
...
// getAvailableSpecializations(Authentication authentication) {
// String firebaseUid = authentication.getName();
// List<Midwife> midwives = midwifeService.getAllMidwives(firebaseUid);
