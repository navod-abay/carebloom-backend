...
public class MoHMotherController {
     ...
     * @param authentication The authenticated user
     * @return Detailed information about the mother including child records and workshops
     */
    ...
    public ResponseEntity<?> getMotherDetails(@PathVariable String motherId, Authentication authentication) {
        try {
            ...
            // Get workshops - assuming there might be a relation between workshops and mothers
            // This is a placeholder implementation since the exact relationship is not clear
            ...
            // Since these fields don't exist in the Mother model yet, we'll provide placeholder data
