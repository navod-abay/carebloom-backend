...
@Service("vendorsEmailCheckService")
public class VendorsEmailCheckService {

    private static final Logger logger = LoggerFactory.getLogger(VendorsEmailCheckService.class);
